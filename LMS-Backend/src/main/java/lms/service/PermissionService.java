...
public class PermissionService implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		if(StreamSupport.stream(permissionRepository.findAll().spliterator(), false).count()<4)
		{
			...
			permissionRepository.save(new Permission(2l, "ROLE_ADMINISTRATOR", null));
			permissionRepository.save(new Permission(3l, "ROLE_TEACHER", null));
			permissionRepository.save(new Permission(4l, "ROLE_STUDENT", null));
			permissionRepository.save(new Permission(5l, "ROLE_PLUGIN", null));
		}
	}
