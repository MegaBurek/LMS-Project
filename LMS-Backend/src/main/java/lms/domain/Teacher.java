...
public class Teacher {
	...
	public Teacher(Long id, @Size(max = 50) String firstName, @Size(max = 50) String lastName,
			@Size(max = 20) String personalIdentificationNumber,  Set<CourseTeaching> courseTeachings, Set<Title> title,
	...
	public Teacher(@Size(max = 50) String firstName, @Size(max = 50) String lastName,
			...
			Set<CourseTeaching> courseTeachings, Set<Title> title, Faculty facultyDean,
...
//				sy.add(s.toDTO());
		...
		return new TeacherDTO(this.id, this.firstName, this.lastName, this.personalIdentificationNumber, this.user.toDTO());
	}
