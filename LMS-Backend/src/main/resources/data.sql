...
INSERT INTO `wis`.`course`(`id`,`deleted`,`title`,`ects`,`obligatory`,`description`, `number_of_lectures`,`number_of_exercises`, `version`) VALUES (6,b'0','Economics',6,b'1','Economics focuses on the behaviour and interactions of economic agents and how economies work. Microeconomics analyzes basic elements in the economy, including individual agents and markets, their interactions, and the outcomes of interactions.',12,13,0);
